...
window.addEventListener('load', () => {
    ...
    if (heroSubtitle) {
        typeWriter(heroSubtitle, 'Cybersecurity Professional', 150);
    }
});
...
console.log('%cWelcome to my portfolio! 🛡️', 'color: #00ff41; font-size: 16px; font-weight: bold;');
console.log('%cInterested in cybersecurity? Let\'s connect!', 'color: #b0b0b0; font-size: 14px;');
